...
9. Scroll through the Zip codes to see the issue:
...
13. Use SUBSTR() to get a substring
...
20. Add up the contributions from Georgia:
<pre><code>SELECT SUM(amount) FROM contributions WHERE state = 'GA';</code></pre>

21. Find the average contribution:
...
24. A failed attempt to get all contributors who gave the maximum:
