...
Click the "Create Table" icon (!http://github.com/tthibo/SQL-Tutorial/raw/master/new_table.png!), and you'll get a form allowing you to create a new table. 
...
!http://github.com/tthibo/SQL-Tutorial/raw/master/browse_and_search.png!
...
h3. String Functions: CONCAT, SUBSTRING, TRIM
