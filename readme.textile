...
Each database management system handles importing values from a file a bit differently. The SQLite Manager provides a nice interface for doing data imports from text files ("export":http://office.microsoft.com/en-us/excel/HP100997251033.aspx#export your MS Excel file as a CSV before importing it).
