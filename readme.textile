...
First, let's grab a plain text file full of contributors from the FEC database. Go to http://github.com/tthibo/SQL-Tutorial/raw/master/contributors.txt and save the file as "contributors.txt" somewhere you can find it (your desktop is a good place).
