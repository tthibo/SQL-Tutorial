...
<b>12. Find all contributors from a few southern states:</b>
<pre><code>SELECT * FROM contributors WHERE state IN ('AL', 'GA', 'FL');</code></pre>

(Note: A compound statement could accomplish this same goal:  <code>state = 'AL' OR state = 'GA' OR state = 'FL'</code> 
