...
!https://raw.githubusercontent.com/tthibo/SQL-Tutorial/master/NICAR2016/images/customize_menu.png!
...
<pre><code>
INSERT INTO contributions (committee_id, entity_type, last_name, first_name, middle_name, city, state, zip_code, employer, occupation, date, amount) VALUES ('C00494740','IND','BUFFETT','WARREN','OMAHA','Nebraska','68131','BERKSHIRE HATHAWAY/CHAIRMAN','CHAIRMAN','2500');
</code></pre>
...
<pre><code>
INSERT INTO contributions (committee_id, entity_type, last_name, first_name, city, state, zip_code, employer, occupation, date, amount) VALUES ('C00494740','IND','WINFREY','OPRAH','','CHICAGO','IL','60607','HARPO INC.','CHAIRMAN/CEO','2015-03-03',500);
INSERT INTO contributions (committee_id, entity_type, last_name, first_name, city, state, zip_code, employer, occupation, date, amount)  VALUES ('C00494740','IND','PRITZKER','PENNY','S','CHICAGO','IL','60614','HYATT','EXEC','2015-03-14',2500);
INSERT INTO contributions (committee_id, entity_type, last_name, first_name, city, state, zip_code, employer, occupation, date, amount) VALUES ('C00431171','IND','ADELSON','SHELDON','','LAS VEGAS','NV','89109','VENETIAN HOTEL','OWNER','2015-10-10','2500');
INSERT INTO contributions (committee_id, entity_type, last_name, first_name, city, state, zip_code, employer, occupation, date, amount) VALUES ('C00431171','IND','MARRIOTT','BILL MR. JR.','','BETHESDA','MD','20817','MARRIOTT INTERNATINAL INC.','CHAIRMAN & C.E.O.','2015-11-19','587');
</code></pre>
...
a. Go to ["https://raw.githubusercontent.com/tthibo/SQL-Tutorial/master/NICAR2016/contributions.txt":https://raw.githubusercontent.com/tthibo/SQL-Tutorial/master/NICAR2016/contributions.txt]
